...
2. **技能页面 (公用)**：技能分类展示，详细技能信息（图文/视频链接），常见痛点分析，针对性练习处方推荐。
3. **训练打卡 (学生专属)**：结构化的训练记录（记录日期、时长、重点练习技能、自由备注）。
4. **教练日程 (教练专属)**：以按天列表或日历形式展示当日所有课程安排，快速对应学员上课时间。
...
| 技能页面 | 技能详情 | 详细说明、动作示范、技术要点、常见痛点列表与对应的练习处方指导。支持动作示范图片点击全屏预览与双指缩放 |
| 打卡记录 (Tab 3 - 学生) | 训练打卡 | 学生模式专属 Tab 3，图标为 `BookOpen`。支持记录练习日期、时长、关联本次重点练习技能并添加自由备注 |
| 教练日程 (Tab 3 - 教练) | 日程表 | 教练模式专属 Tab 3，图标为 `Calendar`。按天展示当天所有学员的课程安排及对应时间段 |
| 学员管理 (Tab 4 - 教练) | 学员列表 | 教练模式专属 Tab 4，图标为 `Users`。展示所有学员的简要进度和最近上课时间 |
| 学员管理 | 学员档案 | 查看特定学员的整体技能掌握进度、各项技能的痛点标记、历史课程记录 |
| 学员管理 | 单节教案规划 | 为学员的某节课创建教案：选择重点突破技能与痛点，关联练习处方，并填写课后总结 |
